# cluster-cloud-controller-manager-operator Domain Models
...
This directory documents the domain models, custom resource definitions (CRDs), and core data structures used in cluster-cloud-controller-manager-operator.
...
- [Development Guide](../cluster-cloud-controller-manager-operator_DEVELOPMENT.md) - Adding new fields
