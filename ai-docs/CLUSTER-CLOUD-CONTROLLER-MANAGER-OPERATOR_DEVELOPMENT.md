# cluster-cloud-controller-manager-operator Development Guide
...
This guide covers the development workflow for cluster-cloud-controller-manager-operator.
...
```bash
git clone https://github.com/openshift-splat-team/cluster-cloud-controller-manager-operator.git
...
# Or directly
go build -o bin/cluster-cloud-controller-manager-operator ./cmd/...
```
...
# Or with podman
podman build -t cluster-cloud-controller-manager-operator:latest .
```
...
# Run
./bin/cluster-cloud-controller-manager-operator --help
```
...
# Or via command line
./bin/cluster-cloud-controller-manager-operator --log-level=debug
```
...
# Debug
dlv debug ./cmd/cluster-cloud-controller-manager-operator
```
...
- [Testing Guide](cluster-cloud-controller-manager-operator_TESTING.md) - Test suites and strategies
