# cluster-cloud-controller-manager-operator Ecosystem and References
...
This document provides links to related projects, upstream dependencies, documentation, and external resources relevant to cluster-cloud-controller-manager-operator.
...
**Relationship:** cluster-cloud-controller-manager-operator runs on Kubernetes
...
**Relationship:** cluster-cloud-controller-manager-operator is part of OpenShift platform
...
Key libraries and frameworks used by cluster-cloud-controller-manager-operator:
...
- [Development Guide](../cluster-cloud-controller-manager-operator_DEVELOPMENT.md) - Build and develop
- [Testing Guide](../cluster-cloud-controller-manager-operator_TESTING.md) - Test suites
