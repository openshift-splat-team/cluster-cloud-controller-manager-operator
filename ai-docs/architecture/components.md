# cluster-cloud-controller-manager-operator Components
...
This document describes the major components and architecture of cluster-cloud-controller-manager-operator.
...
- [Development Guide](../cluster-cloud-controller-manager-operator_DEVELOPMENT.md) - How to build and run
- [Testing Guide](../cluster-cloud-controller-manager-operator_TESTING.md) - How to test components
